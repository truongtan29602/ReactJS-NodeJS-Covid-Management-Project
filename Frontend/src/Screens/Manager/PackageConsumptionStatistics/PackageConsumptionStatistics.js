...
import "./PackageConsumptionStatistics.css";
import Chart from "react-apexcharts";

const PackageConsumptionStatistics = (props) => {
  ...
  useEffect(() => {
    ...
    dispatch(UserActions.getPackageConsumptionStatisticsData()).then(
      (result) => {
        setSeries((prev) => [
          {
            name: "Total package consumed",
            data: [
              result.month1["total"],
              result.month2["total"],
              result.month3["total"],
    ...
    <div className="statistics-wrapper">
      ...
      <div className="col-9">
        <div className="section">
          <div className="section-title">Package Consumption statistics</div>
...
export default PackageConsumptionStatistics;
